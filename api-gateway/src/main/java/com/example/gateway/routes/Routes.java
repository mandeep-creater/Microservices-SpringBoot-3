...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoute(){
        return route("product_service")
                .route(RequestPredicates.path("/api/product/g"), HandlerFunctions.http("http://localhost:8081"))
    ...
    public RouterFunction<ServerResponse> inventoryServiceswaggerRoute(){
        return route("inventory_service_swagger")
                .route(RequestPredicates.path("/aggregate/swagger-service/v3/api-docs"), HandlerFunctions.http("http://localhost:8083"))
                .filter(setPath("/api-docs"))
                .build();
    }
